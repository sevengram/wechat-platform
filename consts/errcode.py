...
wechat_map = defaultdict(lambda: (9001, '请求失败'), {
    ...
    40013: (9001, '不合法的AppID，请开发者检查AppID的正确性，避免异常字符，注意大小写'),
    40014: (9001, '不合法的access_token，请开发者认真比对access_token的有效性（如是否过期），或查看是否正在为恰当的公众号调用接口'),
    40015: (9001, '不合法的菜单类型'),
    40016: (9001, '不合法的按钮个数'),
    40017: (9001, '不合法的按钮个数'),
    ...
    41009: (9001, '缺少openid'),
    42001: (9001, 'access_token超时，请检查access_token的有效期，请参考基础支持-获取access_token中，对access_token的详细机制说明'),
    ...
    48001: (9001, 'api功能未授权，请确认公众号已获得该接口，可以在公众平台官网-开发者中心页中查看接口权限'),

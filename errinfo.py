...
err_map = defaultdict(lambda: ('FAIL', 'ERROR'), {
    0: ('SUCCESS', 'OK'),
    1: ('FAIL', 'ERROR'),
    1001: ('SYSTEMERROR', 'wechat通讯错误'),
    1002: ('NOTWECHAT', 'wechat签名错误'),
    1003: ('ACCESS_ERROR', '获取access_token时AppSecret错误，或者access_token无效'),
    1004: ('TOKEN_ERROR', '不合法的access_token'),
    1101: ('API_NOT_AUTH', 'api功能未授权'),
    2001: ('INVALIDCODE', '不合法的oauth_code'),
    2002: ('USERNOTEXIST', '用户不存在'),
    3001: ('NOTENOUGH', '用户余额不足'),
    3101: ('ORDERPAID', '商户订单已支付'),
    3102: ('ORDERCLOSED', '订单已关闭'),
    3103: ('OUT_TRADE_NO_USED', '商户订单号重复'),
    3104: ('ORDERNOTEXIST', '此交易订单号不存在'),
    3201: ('APPID_NOT_EXIST', 'APPID不存在'),
    3301: ('TRANSACTION_ID_INVALID', '订单号非法'),
    4101: ('INVALID_MSG_TYPE', 'msg_type不合法'),
    7000: ('MOCK_HTTP_ERROR', 'wechat模拟访问错误'),
    7001: ('MOCK_LOGIN_EXPIRED', 'wechat模拟登录超时'),
    7002: ('MOCK_LOGIN_ERROR', 'wechat模拟登录请求错误'),
    7101: ('MOCK_USER_NOTFOUND', 'wechat模拟访问无法找到用户'),
    7102: ('MOCK_FAKEID_NOT_FOUND', 'wechat模拟访问fakeid未找到'),
    7103: ('MOCK_TICKET_NOTFOUND', 'wechat模拟访问ticket未找到'),
    7104: ('MOCK_SEQ_NOTFOUND', 'wechat模拟访问operation_seq未找到'),
    7105: ('MOCK_NEWS_NOTFOUND', 'wechat模拟访问news未找到'),
    7201: ('MOCK_MULTIMSG_LIMIT', 'wechat模拟访问群发超过上限'),
    8001: ('SIGNERROR', '签名错误'),
    8002: ('NOSIGN', '找不到授权签名'),
    9001: ('OTHERS', '其他错误'),
    9002: ('NETWORK_ERROR', '网络请求失败'),
    9003: ('NETWORK_DATA_ERROR', '网络数据错误'),
    9101: ('JSON_ERROR', 'JSON数据格式错误')
})

alias_map = {v1: k for k, (v1, v2) in err_map.items()}
...
wechat_map = defaultdict(lambda: (9001, '请求失败'), {
    ...
    40033: (9001, '不合法的请求字符, 不能包含uxxxx格式的字符'),
    40035: (9001, '不合法的参数'),
    40038: (9001, '不合法的请求格式'),
